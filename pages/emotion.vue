<template>
      ...
      <v-container> <!-- Centers the home page -->
        <v-row justify="center" align="center">
          <v-col>
            <!-- appbar Component -->
            <appbar />
   <h4 style="color:black">Feeling {{ this.emotion }}? Here is something for you 🙂</h4>
           <!-- QuoteCard Component -->
           <quotecard 
          :quotes="quotes"
  ...
  if (savedQuotes) {
    ...
    if (this.quotes.length) {
      this.$refs.messagebar.snackbar = true;
      this.snackText = "Offline mode saves the day - Data found for " + this.emotion;
      this.showLoadButton = false;
    } else {
      console.log("No saved quotes found for the specified emotion");
      this.snackText = "Offline - No results for " + this.emotion + ", keep the faith!"
      this.$refs.messagebar.snackbar = true;
      this.showLoadButton = false;
    }
  } else {
    console.log("No saved quotes found");
    this.snackText = "Trust in God - Offline mode: No results found for " + this.emotion;
    this.$refs.messagebar.snackbar = true;
    this.showLoadButton=false
  }
