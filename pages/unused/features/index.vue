          ...
          <div class="pt-2 pb-2">
            <div v-if="reqs.length < 1">
              <div class="wide-block pt-2 pb-2">
                <div
                  class="alert alert-outline-primary text-center"
                  role="alert"
                >
              ...
              <div class="item">
                ...
                <div class="in">
                  <div class="comment-header">
                    ...
                    <span class="time">{{
                      $luxon.fromISO(req.created_at).toRelative()
                    }}</span>
                  </div>
                  <div class="text">
                    {{
                      req.comments.length > 120
                        ? req.comments.slice(0, 120) + "..."
                        : req.comments
                    }}
                  </div>
            ...
            <div class="section full d-flex justify-content-center mt-4">
              <div>
                ...
                >
                  Load More
                  <span
                    class="spinner-border spinner-border-sm mr-05 ml-1"
                    role="status"
                    aria-hidden="true"
                    v-if="spinner"
                  ></span>
      ...
      <div class="modal-body">
        <div class="login-form">
          <div class="section mt-2">
            <h4>
              Help us improve our product by submitting your feature requests
            </h4>
          </div>
          <div class="section mt-4 mb-5">
            ...
            <small>
              Please provide a detailed description of the feature you would
              like to see added to our product.
              <br />
...
<!-- * top right -->```
  ...
  export default {
    ...
    head() {
      return {
        title: "PrayerPath - Request New Features",
        meta: [
          {
            hid: 'description',
            name: 'description',
