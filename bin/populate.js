...
const category = ['Family', 'Hope', 'Supplication', 'Grace', 'Marriage', 'Health', 'Career', 'Peace', 'Protection', 'Guidance', 'Joy', 'Wisdom', 'Strength', 'Blessing', 'Salvation', 'Fertility', 'Healing'][Math.floor(Math.random() * 15)];
